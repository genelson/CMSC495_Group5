 ...
 * @author Larry
 */
public class VideoManagementSystemGUI extends javax.swing.JFrame {
    ...
    public VideoManagementSystemGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        removeCustomerDropDownList.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "test 1", "test2" }));
